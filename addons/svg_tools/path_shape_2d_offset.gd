@tool
class_name PathShape2DOffset
extends PathShape2DNested

## [PathShape2D] that generates points offset from another [PathShape2D]
##
## This resource contains another [PathShape2D]. It takes the
## source's [method PathShape2D.get_baked_points] and outputs
