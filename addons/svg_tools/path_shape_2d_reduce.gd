@tool
class_name PathShape2DReduce
extends PathShape2DNested

## Reduces the points of a [PathShape2D]
##
## This resource references another [PathShape2D] resource, and exposes the
...
## interval, at runtime depending on the source [PathShape2D] being used.
