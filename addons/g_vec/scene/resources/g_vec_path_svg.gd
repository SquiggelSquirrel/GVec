...
func _get_property_list() -> Array[Dictionary]:
	...
	properties.append({
		"name": "segment_count",
		"type": TYPE_INT,
		"usage": PROPERTY_USAGE_ARRAY | PROPERTY_USAGE_EDITOR,
...
func get_segment_property(
	...
	return get(segment_property_to_name(
...
func get_segment_property_list(segment_index: int) -> Array[Dictionary]:
	...
	properties.append({
		...
		"hint_string": "Line,Quadratic,Cubic,Arc with Endpoint,Arc with Center"
	})
...
func get_vector_out() -> Vector2:
	if _segments.size() == 0:
		return Vector2.ZERO
	return _segments[-1].get_vector_out()
